...
description: 'Master Services Agreement between YAT College and MTS Consulting governing the Website Cloud Infrastructure Improvement project.'
appearsIn:
  - s1-cl3-at1
order: 1
---
...
| | |
|---|---|
| **Agreement reference** | YAT-MTS-2026-005 |
| **Effective date** | 4 May 2026 |
| **Project** | Website Cloud Infrastructure Improvement |
...
A. YAT operates its public website (the **Website**) — the marketing site, course catalogue, and online enquiry / application intake — in a cloud-hosted environment in AWS region `ap-southeast-2` (Sydney). The Website was YAT's first cloud system, migrated from on-premises in 2023 as a deliberately simple single-Availability-Zone deployment.
...
E. The Website is a public service reached by anonymous members of the public over the open internet; YAT requires that any improvement be proportionate and cost-justified, and that production change avoid the peak enrolment-intake periods.
...
| **Indian Regulatory Requirements** | The Indian regulatory obligations applicable to the YAT India-campus operation the Website serves, as determined and maintained by the YAT Compliance area, summarised for reference in the Indian Regulatory Requirements document for this project. |
| **MSA** | This Master Services Agreement. |
| **Peak Intake Period** | The principal enrolment and application-intake windows, during which production changes to the Website are avoided. |
...
- The **legal interpretation** of the Indian Regulatory Requirements and of YAT's obligations as a handler of personal data — MTS assesses and improves the cloud infrastructure against the requirements as determined by the YAT Compliance area, and does not advise on the law;
- The Website content and CMS application, content authoring, and any application-level change to the Website itself (retained by YAT Marketing & Admissions);
- India-cohort enquiry handling and admissions processing;
- Production cutover or transition of any improved service, scheduled to avoid the Peak Intake Period;
- All organisational change-management activities, including Change Advisory Board process, communications, and training; and
...
The detailed delivery schedule for each Phase, including milestone dates, is maintained by the Engagement Director (clause 10.2) and reviewed at the fortnightly principals meeting. Production-affecting work is scheduled to avoid the Peak Intake Period.
...
| **Website business owner** | Dana Mercer, Marketing & Admissions Manager | — |
...
**Executed as an Agreement on 4 May 2026.**
