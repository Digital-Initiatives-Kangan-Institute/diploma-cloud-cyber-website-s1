...
description: 'Master Services Agreement between YAT College and MTS Consulting governing the Enrolline (Student Records) Cloud Infrastructure Improvement project.'
appearsIn:
  - s1-cl3-at1
  - s1-cl3-at2
  - s1-cl3-at3
...
| | |
|---|---|
| **Agreement reference** | YAT-MTS-2027-002 |
| **Effective date** | 2 February 2027 |
| **Project** | Enrolline Cloud Infrastructure Improvement |
...
A. YAT operates its student records and enrolment management system (the **Student Records System**, the **Enrolline** platform) in a cloud-hosted environment in AWS region `ap-southeast-2` (Sydney), migrated from on-premises under a prior engagement. Enrolline runs on Amazon Linux 2023 with an Amazon RDS for PostgreSQL database and an Amazon S3 document store, and is reached by YAT admissions, student services, faculty administration, and compliance staff.

B. YAT has established an offshore campus partnership in India. As a result, Enrolline holds the enrolment and student records of students recruited and taught through an operation that is subject to Indian regulatory requirements, and YAT wishes to confirm that the system's cloud infrastructure is **stable, reliable, and fit for purpose**, and that it is **compliant with the Indian regulatory requirements** applicable to that operation.

C. YAT has determined to engage an external consultancy to **analyse** the current state of Enrolline's cloud infrastructure, **propose improvements** (across reliability, scalability, security, cost, and regulatory compliance) in a Solution Design for YAT's approval, and **implement the improvements YAT approves**.

D. YAT has determined that the cloud infrastructure work is delivered by the consultancy under a Master Services Agreement, while the Enrolline application, the student data, and the legal interpretation of YAT's regulatory obligations are retained by YAT in-house ICT, Student Administration, and Compliance teams.

E. Enrolline is an internal, staff-facing system whose load is concentrated in scheduled intake and census windows; YAT requires that any improvement be proportionate and cost-justified, and that production change avoid the intake enrolment windows, the periods either side of a census date, and the annual statutory reporting window.

F. YAT has selected MTS to provide the cloud infrastructure services described in this Agreement. MTS warrants that it has the capability, qualifications, and resources to provide the Services.

G. The Parties wish to record the terms on which MTS will provide the Services to YAT.
...
| **Census Date** | A date fixed under YAT's regulatory obligations by which a student's enrolment in a training product must be confirmed, as published in the YAT academic calendar. |
...
| **Confidential Information** | Information disclosed by one Party to the other that is identified as confidential or that a reasonable person would treat as confidential, including YAT-held personal information, YAT student records, and any non-public technical, operational, or commercial information of either Party. |
...
| **Improvement Team** | The team of MTS personnel assigned to deliver the Engagement, as described in the Engagement Role Brief. |
| **Indian Regulatory Requirements** | The Indian regulatory obligations applicable to the YAT India-campus operation as determined and maintained by the YAT Compliance area, summarised for reference in the Indian Regulatory Requirements document for this project. |
| **Intake Enrolment Window** | The period during which enrolments for an intake are processed, being the first three weeks of February and the first three weeks of July, as published in the YAT academic calendar. |
| **MSA** | This Master Services Agreement. |
| **Phase** | A phase of the Engagement as described in clause 4. |
| **Restricted Period** | Each Intake Enrolment Window, the week either side of each Census Date, and the annual AVETMISS submission window in January, during which production changes to Enrolline are avoided. |
| **Services** | The services to be performed by MTS as described in clause 4. |
| **Site** | The YAT Cremorne campus and, where the context requires, the YAT-controlled cloud environment within the scope of the Engagement. |
...
|---|---|---|
| Phase 1 | Analysis and Solution Design | Review the current Enrolline cloud infrastructure; assess its stability, reliability, and fitness for purpose, and its compliance with the Indian Regulatory Requirements applicable to the India-campus operation; identify and evaluate improvement options across reliability, scalability, security, and cost; set the improvement goals and performance metrics; prepare a Solution Design setting out the recommended improvements, each with its cost-benefit justification; and present it to YAT for approval before any implementation. |
...
- **Phase 1 scope** is anchored by the Engagement Role Brief, the Improvement Requirements, the Consultation Notes, the Indian Regulatory Requirements, and the current-state Enrolline records (the Enrolline Infrastructure Specifications, Application Specification, Network Diagram, Operational Costing, and the Enrolline Cloud Architecture — Baseline Design).
...
The following work is **not** included in this Engagement and remains the responsibility of YAT in-house ICT, Student Administration, and Compliance teams:

- The **legal interpretation** of the Indian Regulatory Requirements and of YAT's obligations as a handler of personal data and student records — MTS assesses and improves the cloud infrastructure against the requirements as determined by the YAT Compliance area, and does not advise on the law;
- Changes to the Enrolline application itself, and all handling, migration, or reconciliation of student data;
- Production cutover or transition of any improved service, scheduled to avoid the Restricted Period;
- All organisational change-management activities, including Change Advisory Board process, communications, admissions and student-services team training, and post-change end-user support;
- All routine end-user support, helpdesk, and YAT-side operational ICT activities;
- YAT's AVETMISS reporting and regulatory-audit obligations, which remain with the YAT Compliance area.

This out-of-scope allocation is reflected in the YAT-internal cost categories for this project. Any change to this allocation requires a Change Request under clause 9.
...
|---|---|---|---|
| D1.1 | Current-state analysis of the Enrolline cloud infrastructure, including its assessment against stability, reliability, and fitness-for-purpose, and against the Indian Regulatory Requirements | Written analysis document | Submitted document; ICT Manager review |
...
| Ref | Deliverable | Format | Acceptance evidence |
|---|---|---|---|
| D2.1 | Approved Improvements implemented in the cloud environment | Running cloud infrastructure | Test/monitoring evidence against the agreed goals and metrics; ICT Manager review of the deployed environment |
| D2.2 | Deployment Report — as-deployed configuration, test results, changes from the approved design, and a long-term improvement strategy | Written report | Submitted report; ICT Manager acceptance |
| D2.3 | Final sign-off and project closure | Closure pack + sign-off record | ICT Manager + senior management sign-off under the Change Management Procedure |

The detailed delivery schedule for each Phase, including milestone dates, is maintained by the Engagement Director (clause 10.2) and reviewed at the fortnightly principals meeting. Production-affecting work is scheduled to avoid the Restricted Period.

## 7. Term, suspension, and termination

### 7.1 Term

This Agreement commences on the Effective Date and continues until Acceptance of Deliverable D2.3 (final sign-off and project closure) or earlier termination under this clause.
...
| **System owner** | Jess Tran, Registrar | — |
| **Engagement Director** | — | Jordan Chen, Engagement Director |
| **Senior Consultant** | — | Pat Lin, Senior Consultant (supervising the Improvement Team) |
...
|---|---:|
| Phase 1 — Analysis and Solution Design | $48,000 |
| Phase 2 — Implementation | $72,000 |
| **Total Engagement** | **$120,000** |

The Phase 2 fee is an indicative ceiling; the fee for the Approved Improvements is confirmed at the Phase 1 gate and varied, if required, by a Change Request under clause 9.
...
(b) the Indian Regulatory Requirements applicable to the India-campus operation, as determined by the YAT Compliance area; and

(c) the YAT Privacy / Data Handling Policy (incorporated by reference).

MTS acknowledges that Enrolline holds student personal information as its principal content, including identity evidence and records that YAT must retain as regulatory evidence, and will treat access to that environment accordingly.

### 12.3 Data residency

YAT data, including any personal information or student records of YAT students or staff, must be processed and stored in accordance with the residency obligations determined by the YAT Compliance area — Australian residency for YAT data generally, and the Indian Regulatory Requirements for the India-campus operation where those apply. Cloud services used under this Engagement must be configured to use the regions required to meet those obligations. Engagement of any service outside an approved region requires the privacy impact assessment process in the YAT Privacy / Data Handling Policy.
...
**Executed as an Agreement on 2 February 2027.**
