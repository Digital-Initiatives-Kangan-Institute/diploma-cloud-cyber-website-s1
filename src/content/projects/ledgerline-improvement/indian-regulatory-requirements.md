...
description: 'The YAT Compliance area’s reference list of the Indian regulatory obligations applicable to the Accounting System following the India-campus partnership — the instruments the Improvement Team assesses the infrastructure against.'
appearsIn:
  - s1-cl3-at1
order: 5
uocReferences:
...
**Consequence:** the system and access logs for the India-related operation are subject to an **in-India residency and 180-day retention** obligation, and must be retrievable quickly enough to support the 6-hour reporting obligation.

### 3. Indian financial-records obligations (Companies Act, 2013; Income-tax Act retention)

As a financial system supporting an Indian operation, Ledgerline's records may be subject to Indian **books-of-account** and tax-record obligations:
...
**Consequence:** the infrastructure supporting the Accounting System's India-related financial records must support their **secure retention, integrity, and retrievability** for the required periods, consistent with where those records must be held.
