...
description: 'Role definitions and engagement-context summary for the MTS Ledgerline Cloud Infrastructure Improvement project — who does what, who reports to whom, who has authority.'
appearsIn:
  - s1-cl3-at1
  - s1-cl3-at2
  - s1-cl3-at3
...
This brief sets out the roles, responsibilities, and reporting relationships for the MTS Ledgerline Cloud Infrastructure Improvement engagement. The Master Services Agreement (§§4–5, §10) is the authoritative source for engagement scope and governance; this brief is the operational reference held by each role during day-to-day work.
...
### YAT Finance and YAT Compliance area

| | |
|---|---|
| **YAT Finance** | System owner of the accounting function; defines the business needs the Accounting System must continue to meet (business-hours service, financial-records handling) and participates in acceptance of business-impacting change. |
| **YAT Compliance area** | Owns the determination and interpretation of the Indian Regulatory Requirements and YAT's obligations as a handler of personal data and financial records. MTS designs and improves the infrastructure to satisfy these requirements; it does not interpret the law. |
...
- Changes to the Ledgerline application and all financial-data handling
- Production cutover of any improved service (scheduled to avoid the Restricted Period)
- Organisational change-management (CAB process, communications, finance-team training, support ramp)
...
- Accounting System Cloud Architecture — Baseline Design (Accounting System Cloud Migration project) — the as-built baseline being improved
- Accounting System Infrastructure Specifications, Application Specification, Operational Costing (ICT) — current-state records
