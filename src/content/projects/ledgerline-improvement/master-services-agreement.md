...
| | |
|---|---|
| **Agreement reference** | YAT-MTS-2027-001 |
| **Effective date** | 2 February 2027 |
| **Project** | Ledgerline Cloud Infrastructure Improvement |
...
C. YAT has determined to engage an external consultancy to **analyse** the current state of the Accounting System's cloud infrastructure, **propose improvements** (across reliability, scalability, security, cost, and regulatory compliance) in a business case for YAT's approval, and **implement the improvements YAT approves**.

D. YAT has determined that the cloud infrastructure work is delivered by the consultancy under a Master Services Agreement, while the Ledgerline application, the financial data, and the legal interpretation of YAT's regulatory obligations are retained by YAT in-house ICT, Finance, and Compliance teams.

E. The Accounting System is an internal, business-hours system; YAT requires that any improvement be proportionate and cost-justified, and that production change avoid the monthly accounting close and the end-of-financial-year period.
...
| **Confidential Information** | Information disclosed by one Party to the other that is identified as confidential or that a reasonable person would treat as confidential, including YAT-held personal information, YAT financial records, and any non-public technical, operational, or commercial information of either Party. |
...
| **Restricted Period** | The monthly accounting close period and the end-of-financial-year (EOFY) period, during which production changes to the Accounting System are avoided. |
...
- **Phase 1 scope** is anchored by the Engagement Role Brief, the Improvement Requirements, the ICT Manager Consultation Notes, the Indian Regulatory Requirements, and the current-state Accounting System records (the Accounting System Infrastructure Specifications, Application Specification, Operational Costing, and the Accounting System Cloud Architecture — Baseline Design).
...
The following work is **not** included in this Engagement and remains the responsibility of YAT in-house ICT, Finance, and Compliance teams:

- The **legal interpretation** of the Indian Regulatory Requirements and of YAT's obligations as a handler of personal data and financial records — MTS assesses and improves the cloud infrastructure against the requirements as determined by the YAT Compliance area, and does not advise on the law;
- Changes to the Ledgerline application itself, and all handling, migration, or reconciliation of financial data;
- Production cutover or transition of any improved service, scheduled to avoid the Restricted Period;
- All organisational change-management activities, including Change Advisory Board process, communications, finance-team training, and post-change end-user support;
...
|---|---|---|---|
| D1.1 | Current-state analysis of the Accounting System cloud infrastructure, including its assessment against stability, reliability, and fitness-for-purpose, and against the Indian Regulatory Requirements | Written analysis document | Submitted document; ICT Manager review |
...
|---|---:|
| Phase 1 — Analysis and Improvement Business Case | $48,000 |
