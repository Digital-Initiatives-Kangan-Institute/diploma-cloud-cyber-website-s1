...
export const PROJECTS: Project[] = [
  {
    ...
    appearsIn: ['s1-cl1-at1', 's1-cl1-at2', 's1-cl1-at3', 's1-cl2-at1', 's1-cl2-at2', 's1-cl3-at1', 's1-cl3-at2', 's1-cl3-at3'],
    stateOverrides: {
      's1-cl2-at1': { status: 'completed', timeline: '2025 – 2026' },
      's1-cl2-at2': { status: 'completed', timeline: '2025 – 2026' },
  ...
  },
  {
    ...
    appearsIn: ['s1-cl2-at1', 's1-cl2-at2'],
  },
  {
  ...
  {
    slug: 'enrolline-cloud-migration',
    displayName: 'MTS – Enrolline Cloud Migration',
    consultancy: 'MTS Consulting',
    status: 'completed',
    timeline: '2025 – 2026',
    summary: 'Migration of YAT’s student records and enrolment management system (Enrolline) from on-premises hosting to AWS. Delivered by MTS Consulting as a single-Availability-Zone deployment in the Sydney region: VPC and networking, the application tier, an RDS for PostgreSQL database, and the S3 document store for student attachments. High-availability hardening was deferred to a follow-on phase and was not carried out. Cloud infrastructure scope only — YAT ICT retained the application install, data migration, cutover, and organisational change management.',
    appearsIn: ['s1-cl3-at1', 's1-cl3-at2', 's1-cl3-at3'],
  },
  {
    slug: 'enrolline-improvement',
    displayName: 'MTS – Enrolline Cloud Infrastructure Improvement',
    consultancy: 'MTS Consulting',
    status: 'current',
    timeline: 'In progress',
    summary: 'Improvement of the YAT Enrolline (student records and enrolment management) cloud infrastructure following the India-campus partnership — assessing whether the system is stable, reliable, fit for purpose, and compliant with Indian regulatory requirements, then proposing improvements in a Solution Design and implementing those approved. Cloud infrastructure scope only — YAT ICT retains the application and student-data responsibilities, and YAT Compliance retains the legal interpretation of the Indian obligations.',
    appearsIn: ['s1-cl3-at1', 's1-cl3-at2', 's1-cl3-at3'],
  },
  {
